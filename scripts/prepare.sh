...
while true; do
    systemctl status pacman-init.service | grep -q 'Finished Initializing Pacman keyring.'
...
sudo reflector --country $country_code --age 10 --latest 10 --protocol https --sort rate --save /etc/pacman.d/mirrorlist
